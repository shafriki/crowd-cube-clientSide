        ...
        <div className="container mx-auto p-4 max-w-screen-xl mb-14">
            ...
            {loading ? (
                            ...
                            <div className="shadow-md rounded-lg overflow-hidden bg-[#e5f1e2]">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <Link to={`/details/${campaign._id}`} className="btn w-full  bg-rose-500  text-white font-semibold hover:bg-rose-700">See More</Link>
                                    </div>
                                </div>
                            </div>
                        </Fade>
                ...
                <div className="text-center my-4 md:my-6">
                    <p>No running campaigns available at the moment.</p>
                </div>
            )}
        </div>
    );
